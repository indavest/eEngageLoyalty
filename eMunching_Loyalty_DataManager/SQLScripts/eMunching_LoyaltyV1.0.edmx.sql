...
GO
IF OBJECT_ID(N'[dbo].[FK_RestaurantUsers_ToUserProfile]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RestaurantUsers] DROP CONSTRAINT [FK_RestaurantUsers_ToUserProfile];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_webpages_UsersInRoles_ToUserProfile]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[webpages_UsersInRoles] DROP CONSTRAINT [FK_webpages_UsersInRoles_ToUserProfile];
GO
IF OBJECT_ID(N'[dbo].[FK_webpages_UsersInRoles_Towebpages_Roles]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[webpages_UsersInRoles] DROP CONSTRAINT [FK_webpages_UsersInRoles_Towebpages_Roles];
GO
...
ALTER TABLE [dbo].[RestaurantUsers]
ADD CONSTRAINT [FK_RestaurantUsers_ToUserProfile]
    FOREIGN KEY ([UserId])
    REFERENCES [dbo].[UserProfiles]
        ([UserId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_RestaurantUsers_ToUserProfile'
CREATE INDEX [IX_FK_RestaurantUsers_ToUserProfile]
